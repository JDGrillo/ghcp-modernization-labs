---
applyTo: "target/react-spring-azure-sql/tests/e2e/**,target/react-dotnet-azure-sql/tests/e2e/**"
---

# Full-stack end-to-end test rules

- Drive tests through user-visible React tasks and verify selected-backend/Azure SQL outcomes against approved characterization cases.
