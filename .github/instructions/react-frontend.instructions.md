---
applyTo: "target/react-spring-azure-sql/frontend/**,target/react-dotnet-azure-sql/frontend/**"
---
...
- Keep authoritative business rules, state transitions, authorization, and monetary calculations in the selected backend.
