...
- Terraform plan integrity, denied public data planes, private DNS and routes, WAF/TLS, managed identities, Entra token flows, least-privilege RBAC, policy compliance, drift, and deployment audit evidence.
